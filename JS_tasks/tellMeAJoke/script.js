...
button.onclick = responsiveVoice.speak("hello world", "UK English Male");
// Passing joke to voicsrss api
function tellMe(joke) {
  responsiveVoice.speak("hello world", "UK English Male", {onstart: StartCallback, onend: EndCallback});
  // responsiveVoice.speak("Do you speak english", "US English Female");
}
